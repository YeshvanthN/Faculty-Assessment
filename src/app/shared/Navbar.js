            ...
            <Dropdown alignRight as="li" className="nav-item">
              ...
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                ...
                <div className="navbar-profile">
                  ...
                  <div className="profile-desc rounded-circle">
                  <div className="menu-icon">
                    <i className="mdi mdi-account-circle"></i>
                  </div>
                  </div>
                  </div>
                  <p className="mb-0 d-none d-sm-block navbar-profile-name"><Trans>Teacher 1</Trans></p>
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list navbar-profile-dropdown-menu">
                ...
                <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}  className="preview-item">
                  <div className="preview-thumbnail">
                    <div className="preview-icon bg-primary rounded-circle">
                      <i className="mdi mdi-logout text-white"></i>
                    </div>
                  </div>
                  <div className="preview-item-content">
                    <p className="preview-subject text-dark mb-1"><Trans>Log Out</Trans></p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
